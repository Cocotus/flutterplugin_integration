...
Pod::Spec.new do |s|
  ...
  s.version          = '0.0.1'
  s.summary          = 'Flutter plugin for ORGACare 930 cardreader.'
  s.description      = <<-DESC
Plugin for Flutter for using german EGK Cardreader ORGACare 930 over bluetooth.
                       DESC
  ...
  s.swift_version = '5.0'
    ...
    # ORGACare 930 WHCCareKit_iOS framework
  ...
  # s.resource_bundles = {'orgacare_reader_sdk_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
end
